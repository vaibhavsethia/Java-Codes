...
{
String ques[] = {"Q1.Who is the Prime Minister of India .","Q2.Who is the CEO of Apple .","Q3.Java is ___________","Q4.Which Of these places has no Speed Limits .","Q5.What was Java originally called ."};
String opn1[] = {"Narendra Modi","Steve Jobs","Boring","Isle Of Man","Fortran"};
String opn2[] = {"Manmohan Singh","Tim Cook","Easy","London","OAK"};
String opn3[] = {"Pratibha Patil","Matt Alonso","Object Oriented","Texas","Pascal"};
String opn4[] = {"Rajendra Prasad","Arachduke Ferdinand","Waste Of Time","Frankfurt","Cobol"};
String ans[] = {"Narendra Modi","Tim Cook","Object Oriented","Isle Of Man","OAK"};
JFrame fr,fr2;
